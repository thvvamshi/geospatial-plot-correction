...
#define __PYX_HAVE__rasterio__cache
#define __PYX_HAVE_API__rasterio__cache
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "cpl_conv.h"
...
#define __pyx_kp_u_rasterio_cache_pyx __pyx_string_tab[2]
#define __pyx_kp_u_utf_8 __pyx_string_tab[3]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[4]
#define __pyx_n_u_as_vsi __pyx_string_tab[5]
...
#define __pyx_n_u_invalidate __pyx_string_tab[10]
#define __pyx_n_u_invalidate_all __pyx_string_tab[11]
...
#define __pyx_n_u_parse_path __pyx_string_tab[17]
#define __pyx_n_u_path __pyx_string_tab[18]
#define __pyx_n_u_pattern __pyx_string_tab[19]
#define __pyx_n_u_pop __pyx_string_tab[20]
#define __pyx_n_u_qualname __pyx_string_tab[21]
#define __pyx_n_u_rasterio__path __pyx_string_tab[22]
#define __pyx_n_u_rasterio_cache __pyx_string_tab[23]
...
#define __pyx_kp_b_iso88591_Q __pyx_string_tab[28]
#define __pyx_kp_b_iso88591_axwa_4waq_AQ __pyx_string_tab[29]
...
/* Python wrapper */
static PyObject *__pyx_pw_8rasterio_5cache_1invalidate(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "invalidate", 0) < (0)) __PYX_ERR(0, 22, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("invalidate", 1, 1, 1, i); __PYX_ERR(0, 22, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("invalidate", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 22, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("rasterio.cache.invalidate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8rasterio_5cache_invalidate(__pyx_self, __pyx_v_pattern);
...
static PyObject *__pyx_pf_8rasterio_5cache_invalidate(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_pattern) {
...
*/
  __pyx_t_4 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_parse_path); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
  ...
  __pyx_t_6 = 0;
  {
    ...
    __pyx_t_1 = __Pyx_PyObject_FastCallMethod((PyObject*)__pyx_mstate_global->__pyx_n_u_as_vsi, __pyx_callargs+__pyx_t_6, (1-__pyx_t_6) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
 ...
 * 
*/
  __pyx_t_7 = __Pyx_PyObject_AsString(__pyx_v_path); if (unlikely((!__pyx_t_7) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
  VSICurlPartialClearCache(__pyx_t_7);
...
/* Python wrapper */
static PyObject *__pyx_pw_8rasterio_5cache_3invalidate_all(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
PyDoc_STRVAR(__pyx_doc_8rasterio_5cache_2invalidate_all, "Invalidate all responses in Rasterio's HTTP cache\n\n    Returns\n    -------\n    None\n    ");
static PyMethodDef __pyx_mdef_8rasterio_5cache_3invalidate_all = {"invalidate_all", (PyCFunction)__pyx_pw_8rasterio_5cache_3invalidate_all, METH_NOARGS, __pyx_doc_8rasterio_5cache_2invalidate_all};
static PyObject *__pyx_pw_8rasterio_5cache_3invalidate_all(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("invalidate_all (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_8rasterio_5cache_2invalidate_all(__pyx_self);
...
static PyObject *__pyx_pf_8rasterio_5cache_2invalidate_all(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("invalidate_all", 0);

  /* "rasterio/cache.pyx":54
 *     None
 *     """
 *     VSICurlClearCache()             # <<<<<<<<<<<<<<
*/
...
namespace {
  ...
  #endif
  {
      ...
      "cache",
      __pyx_k_Rasterio_caches_HTTP_responses_u, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_RefNannySetupContext("PyInit_cache", 0);
  ...
  if (__pyx_module_is_main_rasterio__cache) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "rasterio.cache")) {
      if (unlikely((PyDict_SetItemString(modules, "rasterio.cache", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_parse_path};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_rasterio__path, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8rasterio_5cache_1invalidate, 0, __pyx_mstate_global->__pyx_n_u_invalidate, NULL, __pyx_mstate_global->__pyx_n_u_rasterio_cache, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_invalidate, __pyx_t_2) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8rasterio_5cache_3invalidate_all, 0, __pyx_mstate_global->__pyx_n_u_invalidate_all, NULL, __pyx_mstate_global->__pyx_n_u_rasterio_cache, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_invalidate_all, __pyx_t_2) < (0)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "rasterio/cache.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init rasterio.cache", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init rasterio.cache");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{1},{18},{5},{20},{6},{18},{18},{6},{8},{10},{14},{13},{5},{8},{10},{8},{11},{4},{7},{3},{12},{14},{14},{12},{10},{8},{6},{9},{35}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (283 bytes) */
const char* const cstring = "BZh91AY&SY\231\332\201\262\000\000\010\377\362\346\r\001\004\000C\204H\244\001p\000\277o\377\340@@@@@\000\000@@\0000\000\315\253\rL\246\223jb\032\030M\250\320h4\r=L\237\245\006\246\232j\231\244\315&\324\364\324\000\000\000m@4&\232\0244\031\0004\000\000d\320\313\025A\301\004\"&<\214\370\266\345r,u\224\351\373B\215>\300\t\r[\210_*\256\301nYD\032\252\037\243St\310B&\325\310w\252\300\326$Jl\222*\352\n\002\320?_\217L\027(\311\353\255\224\2534\nQ\205\204d\215\2422\231\020\276\020\013,S\t\033\306\n\001\251$\341;#\304\035\224D\321\316}\250\007\030Cy\227\026\240$\036\332\331\212F\nS\347@\242\326\213H\237\023\311b\322\352\200\234>\247-\224\3163\233\000-U\341\213\002\006\232\234\330\"\210\031\243\033\006\371f\024\006\013m\256b\2514\223O\257\307c\203\322p\217\242\025\326\361\374]\311\024\341BBgj\006\310";
    PyObject *data = __Pyx_DecompressString(cstring, 283, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (233 bytes) */
const char* const cstring = "x\332EO1N\003A\014\014RR\201(\251\362\000\032\216\206\002\211\002!\245F\204\017X\306\347SV\331\333\275\254\275\311]Gy\345\225W\362\254<\203'\340\204\020,y<\226G#O\361\234P\224\223\213\367\204\264\342\242\351\332\254\325\335#\300[\327Z/\034)\274r\253\357\\\241\300V\034J\027\310\305\202b\212Y]`!o\010.\200&$\376@Zs\240X2@\225\003\201]\266\350]\211\312\377\014\320{p\002g\027\247\\\013@\215\346cU\3072{>\260\200\365a6\230\204\ruuj\373:4\261\001\330d\364\277\242\277,\305Qw\336\216\311\000\204\365df\254\2648\331+\200\262\030\332[\231\345\363\342\373z2\273\031\226Fn'\263\253\376i\300\241\035w_\270\237^\366\017\375\316\326\315~:\037_\306\345\017\004T|\375";
    PyObject *data = __Pyx_DecompressString(cstring, 233, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (314 bytes) */
const char* const bytes = ".?rasterio/cache.pyxutf-8__Pyx_PyDict_NextRefas_vsiasyncio.coroutinescline_in_tracebackencode__func__invalidateinvalidate_all_is_coroutineitems__main____module____name___parse_pathpathpatternpop__qualname__rasterio._pathrasterio.cache__set_name__setdefault__test__values\200\001\360\016\000\005\026\220Q\200\001\360(\000\005\014\210;\220a\220x\230w\240a\330\004\013\2104\210w\220a\220q\330\004\034\230A\230Q";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_pattern, __pyx_mstate->__pyx_n_u_path};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_rasterio_cache_pyx, __pyx_mstate->__pyx_n_u_invalidate, __pyx_mstate->__pyx_kp_b_iso88591_axwa_4waq_AQ, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {0, 0, 0, 0, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 47};
    PyObject* const varnames[] = {0};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_rasterio_cache_pyx, __pyx_mstate->__pyx_n_u_invalidate_all, __pyx_mstate->__pyx_kp_b_iso88591_Q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
